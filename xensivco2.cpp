 ...
 * @pre     None
 */
Error_t XensivCO2::begin(bool i2c, bool uart)
{
 ...
 * @pre     begin()
 */
Error_t XensivCO2::end(bool i2c, bool uart)
{
 ...
 * @pre         begin()
 */
Error_t XensivCO2::startMeasure(int16_t periodInSec, int16_t alarmTh, void (*cback) (void *))
{
    xensiv_pasco2_measurement_config_t  measConf;
 ...
 * @pre         startMeasure()
 */
Error_t XensivCO2::getCO2(uint16_t & CO2PPM)
{
    int32_t ret = XENSIV_PASCO2_OK;
 ...
 * @pre         None
 */
Error_t XensivCO2::getDiagnosis(Diag_t & diagnosis)
{
    int32_t ret = XENSIV_PASCO2_OK;
 ...
 * @pre         begin()
 */
Error_t XensivCO2::setABOC(ABOC_t aboc, int16_t abocRef)
{
    xensiv_pasco2_measurement_config_t  measConf;
    int32_t ret = XENSIV_PASCO2_OK;
 ...
 * @pre         begin()
 */
Error_t XensivCO2::setPressRef(uint16_t pressRef)
{
    int32_t ret = XENSIV_PASCO2_OK;
 ...
 * @pre         begin()
 */
Error_t XensivCO2::getDeviceID(uint8_t & prodID, uint8_t & revID)
{
    int32_t ret = XENSIV_PASCO2_OK;
